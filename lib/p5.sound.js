/** [p5.sound]  Version: 1.0.0 - 2021-04-30 */ 
 /**
...
// CONCATENATED MODULE: ./audioworklet-polyfill/realm.js
/**
...
var PARAMS = [];
var nextPort;
var audioworklet_polyfill_ua = navigator.userAgent.toLowerCase();
var audioworklet_polyfill_isSafariIos = audioworklet_polyfill_ua.indexOf('iphone') > -1 && audioworklet_polyfill_ua.indexOf('safari') > -1;
var audioworklet_polyfill_isUsingWorkletsPolyfill = audioworklet_polyfill_isSafariIos || typeof AudioWorkletNode !== 'function' || !('audioWorklet' in AudioContext.prototype);

if (audioworklet_polyfill_isUsingWorkletsPolyfill) {
  self.AudioWorkletNode = function AudioWorkletNode(context, name, options) {
    ...
    var scriptProcessor = context.createScriptProcessor(1024, 2, outputChannels);
...
function onAudioProcess(e) {
  ...
  this.parameters.forEach(function (value, key) {
    var arr = PARAMS[++index] || (PARAMS[index] = new Float32Array(1024)); // @TODO proper values here if possible
  ...
  this.instance.process([inputs], [outputs], parameters); // @todo - keepalive
...
var shims = __webpack_require__(24);

// EXTERNAL MODULE: ./audiocontext.js
var audiocontext = __webpack_require__(3);

// CONCATENATED MODULE: ./master.js
function master_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

 // Master contains the master sound output.

var master_Master = function Master() {
  master_classCallCheck(this, Master);
...
function safeBufferSize(idealBufferSize) {
  ...
  var isSafariIos = ua.indexOf('iphone') > -1 && ua.indexOf('safari') > -1;
...
var moduleSources = [__webpack_require__(26)["default"], __webpack_require__(27)["default"], __webpack_require__(28)["default"]];
...
function panner_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function panner_createClass(Constructor, protoProps, staticProps) { if (protoProps) panner_defineProperties(Constructor.prototype, protoProps); if (staticProps) panner_defineProperties(Constructor, staticProps); return Constructor; }
...
function () {
  ...
  audioin_createClass(AudioIn, [{
    ...
    value: function start(successCallback, errorCallback) {
      ...
      var audioSource = master.inputSources[self.currentSource]; // default:

      var ua = navigator.userAgent.toLowerCase();
      var isSafariIos = ua.indexOf('iphone') > -1 && ua.indexOf('safari') > -1;
      var isUsingWorkletsPolyfill = isSafariIos || typeof AudioWorkletNode !== 'function' || !('audioWorklet' in AudioContext.prototype);
      var constraints = {
        audio: {
  ...
  function SoundRecorder(options) {
    ...
    this._workletNode.port.onmessage = function (event) {
      if (event.data.name === 'buffers') {
        options.callback(event.data.leftBuffer, event.data.duration); // options.callback(buffers, )
      }
    }.bind(this);
    /**
